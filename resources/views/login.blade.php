            ...
            <div class="p-6 rounded-lg shadow-lg w-96  ">
                ...
                <form action="/login/submit" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" id="email" class="w-full border border-gray-300 rounded-lg p-2" placeholder="nim@uhamka.ac.id" required>
                    </div>
                    <div class="mb-4">
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    Belum punya akun?
                    <a href="/register" class="font-semibold text-indigo-600 hover:text-indigo-500">Registrasi disini</a>
                  </p>
            </div>
          </div>
        </div>
